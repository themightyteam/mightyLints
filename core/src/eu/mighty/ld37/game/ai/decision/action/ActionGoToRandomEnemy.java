...
public class ActionGoToRandomEnemy  extends ActionFSMNode {

	public ActionGoToRandomEnemy(int idObject, AIIteration aiIteration) {
	...
	public DecisionTreeNode makeDecision() {
		...
		TargetObject target = this.aiIteration.obtainRandomEnemySquare(this.idObject);
